                                            ...
                                            <div class="col-md-10">
                                                <div class="select control">
                                                    <select name="customer_id" class="browser-default custom-select">
                                                        <option selected
                                                                value="{{ $request_s->customer_id }}">{{ App\User::findOrFail($request_s->customer_id)->name }}</option>
                                                        @foreach(App\User::all()->except( $request_s->customer_id) as $customer)
                                                            <option
                                            ...
                                            <div class="col-md-10">
                                                <div class="select control">
                                                    <select name="company_id" class="browser-default custom-select">
                                                        <option selected
                                                                value="{{ $request_s->company_id }}">{{ App\Company::findOrFail($request_s->company_id)->name }}</option>
                                                        @foreach(App\Company::all()->except( $request_s->company_id) as $company)
                                            ...
                                            <div class="col-md-10">
                                                <div class="select control">
                                                    <select name="type" class="browser-default custom-select">
                                                        <option selected
                                                                value="{{ $request_s->type }}">{{ ucfirst($request_s->type) }}</option>
                                            ...
                                            <div class="col-md-10">
                                                <div class="select control">
                                                    <select name="service_id" class="browser-default custom-select">
                                                        <option selected
                                                                value="{{ $request_s->service_id }}">{{ App\Models\Service\Service::findOrFail($request_s->service_id)->name_en }}</option>
                                                        @foreach(App\Models\Service\Service::all()->where('is_sub', 1)->except($request_s->service_id) as $service)
                                                            <option
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('note') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('note') ? ' is-invalid' : '' }}"
                                                   name="note" id="input-name" type="text"
                                                   placeholder="{{ __('Note') }}"
                                                   value="{{ $request_s->note }}"
                                                   aria-required="true"/>
                                            @if ($errors->has('note'))
